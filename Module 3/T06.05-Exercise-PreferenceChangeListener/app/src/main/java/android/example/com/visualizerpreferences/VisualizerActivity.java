...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowBass(sh.getBoolean(getString(R.string.pref_show_bass_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sh, String s) {
        if (s.equals(getString(R.string.pref_show_bass_key))) {
            mVisualizerView.setShowBass(sh.getBoolean(s, getResources().getBoolean(R.bool.pref_show_bass_default)));
            Toast.makeText(this,"Preferences has been changed", Toast.LENGTH_LONG).show();
        }
    }
