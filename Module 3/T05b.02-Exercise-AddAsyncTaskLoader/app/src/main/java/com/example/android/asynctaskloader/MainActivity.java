...
//            mSearchResultsTextView.setText(rawJsonSearchResults);
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery == null || TextUtils.isEmpty(githubQuery)){
            mSearchResultsTextView.setText("Nothing To display");
        }
...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        Loader ourLoader = l.getLoader(GITHUB_SEARCH_LOADER);

        // TODO (23) If the Loader was null, initialize it. Else, restart it.
        if(ourLoader == null){
            l.initLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        } else {
            l.restartLoader(GITHUB_SEARCH_LOADER, queryBundle, this);
        }
    }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                String fromBundle = args.getString(SEARCH_QUERY_URL_EXTRA);
                if(fromBundle == null || TextUtils.isEmpty(fromBundle))
                return null;

                try {
                    URL githubUrl = new URL(fromBundle);
