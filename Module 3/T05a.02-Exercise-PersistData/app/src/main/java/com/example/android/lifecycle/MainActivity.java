...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_LIFECYCLE_CALLBACKS_TEXT_KEY = "LIFECYCLE_CALLBACKS_TEXT_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null && savedInstanceState.containsKey(KEY_LIFECYCLE_CALLBACKS_TEXT_KEY)){
            mLifecycleDisplay.setText(savedInstanceState.getString(KEY_LIFECYCLE_CALLBACKS_TEXT_KEY));
        }
    ...
    public void onSaveInstanceState(Bundle outState, PersistableBundle outPersistentState) {
        ...
        outState.putString(KEY_LIFECYCLE_CALLBACKS_TEXT_KEY, mLifecycleDisplay.getText().toString());
    }
