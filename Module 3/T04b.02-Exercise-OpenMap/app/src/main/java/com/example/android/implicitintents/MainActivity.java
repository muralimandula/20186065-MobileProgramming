...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String address = "Jagathgirigutta, Hyderabad";
    ...
    public void showMap(Uri uri) {
        Intent showingMap = new Intent(Intent.ACTION_VIEW);
        showingMap.setData(uri);

        if (showingMap.resolveActivity(getPackageManager()) != null) {
            startActivity(showingMap);
        }
    }
