...
//                final LiveData<TaskEntry> task = mDb.taskDao().loadTaskById(mTaskId);
                ...
                final AddTaskViewModelFactory viewFactory = new AddTaskViewModelFactory(mDb, mTaskId);

                // TODO (11) Declare a AddTaskViewModel variable and initialize it by calling ViewModelProviders.of
                // for that use the factory created above AddTaskViewModel
                final AddTaskViewModel viewModel = ViewModelProviders.of(this, viewFactory).get(AddTaskViewModel.class);
