...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent intentToWaterReminder = new Intent(this, WaterReminderIntentService.class);

        // TODO (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        intentToWaterReminder.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        // TODO (17) Call startService and pass the explicit intent you just created
        startService(intentToWaterReminder);
    }
