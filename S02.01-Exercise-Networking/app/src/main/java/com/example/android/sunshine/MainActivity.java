...
//        }
    ...
    private void loadWeatherData() {
        String locationToFind = SunshinePreferences.getPreferredWeatherLocation(this);
        new weatherSync().execute(locationToFind);
    }
    ...
    public class weatherSync extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String[] weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherResponse);
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if(weatherData != null) {
                for(String eachLoactionWeather : weatherData) {
                    mWeatherTextView.append(eachLoactionWeather + "\n\n\n");
                }
            }
        }
    }
