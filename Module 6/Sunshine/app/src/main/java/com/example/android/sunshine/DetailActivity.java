...
public class DetailActivity extends AppCompatActivity implements
    ...
    private void takeScreenshot() {
        ...
        try {
            ...
            String mPath = Environment.getExternalStorageDirectory().toString() + "/Pictures/Screenshots/Screenshot_" + date + ".png";
...
//            iv.setImageBitmap(ssbitmap);
            ...
            Toast.makeText(this, "checking screenshot", Toast.LENGTH_LONG).show();
            share(sharePath);
...
//            takeScreenshot();
//            Intent shareIntent = takeScreenshot();
